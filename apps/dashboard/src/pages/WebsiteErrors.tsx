  ...
  return (
    <div className="page page-errors">
      ...
      <section className="panel section-gap">
        <header className="panel-header">
          <div>
            <h2 className="section-title">{t('errorsRecent')}</h2>
        ...
        {!errorsQuery.isLoading && rows.length ? (
          <div className="table-scroll">
            <table className="data-table errors-table">
              <thead>
                <tr>
      ...
      <section className="panel section-gap">
        <header className="panel-header">
          <div>
            <h2 className="section-title">{t('errorSourceMaps')}</h2>
      ...
      <section className="panel section-gap">
        <header className="panel-header">
          <div>
            <h2 className="section-title">{t('errorAlertRules')}</h2>
